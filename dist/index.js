...
var templateExportHook = {"1":function(container,depth0,helpers,partials,data) {
  ...
  return "				 export const useInfinite"
    ...
    + ", options?: Partial<UseInfiniteQueryOptions<any>>) => {\n					 return useInfiniteQuery<"
    + ((stack1 = container.invokePartial(lookupProperty(partials,"result"),depth0,{"name":"result","data":data,"helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "")
    + ">({\n				 		 queryKey: ['"
    + ((stack1 = lookupProperty(helpers,"camelCase").call(alias1,lookupProperty(depth0,"service"),{"name":"camelCase","hash":{},"data":data,"loc":{"start":{"line":37,"column":20},"end":{"line":37,"column":42}}})) != null ? stack1 : "")
    + "', '"
    + ((stack1 = lookupProperty(helpers,"camelCase").call(alias1,lookupProperty(depth0,"name"),{"name":"camelCase","hash":{},"data":data,"loc":{"start":{"line":37,"column":46},"end":{"line":37,"column":66}}})) != null ? stack1 : "")
    + "', "
    + ((stack1 = lookupProperty(helpers,"each").call(alias1,lookupProperty(depth0,"parameters"),{"name":"each","hash":{},"fn":container.program(10, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":37,"column":69},"end":{"line":37,"column":108}}})) != null ? stack1 : "")
